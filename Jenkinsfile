pipeline {
    ...
    parameters {
        ...
        string(name: 'EUREKA_HOST',          defaultValue: '10.0.3.176',   description: 'Eureka private IP')
        string(name: 'CONFIG_HOST',          defaultValue: '10.0.3.48',    description: 'Config-server private IP')
        string(name: 'RABBITMQ_HOST',        defaultValue: '10.0.4.173',   description: 'RabbitMQ private IP')
        string(name: 'KEYCLOAK_HOST',        defaultValue: '10.0.4.76',    description: 'Keycloak private IP')
        ...
        string(name: 'USER_SERVICE_HOST',    defaultValue: '10.0.1.92',    description: 'Private IP of user-service EC2 (from terraform output user_service_private_ip)')
        string(name: 'PAYMENT_SERVICE_HOST', defaultValue: '10.0.2.177',   description: 'Private IP of payment-service EC2 (from terraform output payment_service_private_ip)')
    }
